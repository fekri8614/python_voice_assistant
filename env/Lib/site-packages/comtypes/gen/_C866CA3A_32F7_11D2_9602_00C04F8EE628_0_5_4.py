...
__all__ = [
    'SAFTCCITT_uLaw_8kHzMono', 'SPEI_UNDEFINED', 'SREHypothesis',
    'DISPID_SADefaultFormat', 'ISpeechRecoGrammar',
    'DISPID_SDKGetStringValue', 'DISPID_SLPPartOfSpeech',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRERequestUI',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SOTDataKey',
    'SPVPRI_OVER', 'SPEI_MAX_SR', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRCPause', 'SVSFPurgeBeforeSpeak', 'ISpeechVoice',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRSTText', 'SDTRule',
    'DISPID_SGRsDynamic', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPAs_NewEnum', 'SP_VISEME_9', 'SAFTGSM610_22kHzMono',
    'SPRS_INACTIVE', 'SVSFParseMask', 'DISPID_SPRuleConfidence',
    'DISPID_SWFEExtraData', 'DISPID_SDKDeleteKey',
    'DISPID_SPIGetText', 'SINoSignal', 'SECFNoSpecialChars',
    'SPEVENTENUM', 'DISPID_SRRPhraseInfo', 'ISpRecognizer2',
    'DISPID_SGRSTPropertyId', 'SECFIgnoreCase', 'SpVoice',
    'DISPID_SLWLangId', '__MIDL_IWinTypes_0009',
    'DISPID_SPIGrammarId', 'SPSMF_UPS', 'DISPID_SPPId',
    'DISPID_SRCEAudioLevel', 'SPEI_HYPOTHESIS', 'DISPID_SRProfile',
    'DISPID_SpeechPhraseProperties', 'SpeechGrammarTagWildcard',
    'SAFTCCITT_ALaw_44kHzMono', 'SPPHRASERULE',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpStreamFormatConverter',
    'DISPID_SpeechPhraseAlternates', 'SPAUDIOBUFFERINFO',
    'DISPID_SRGRecoContext', 'SAFT44kHz16BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechObjectTokens',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechPhraseProperties',
    'SpeechRecognitionType', 'ISpeechGrammarRuleStateTransition',
    'SPBOOKMARKOPTIONS', 'SP_VISEME_3', 'DISPID_SGRName', 'SVP_6',
    'DISPID_SASetState', 'SPSHT_NotOverriden', 'DISPID_SLWs_NewEnum',
    'DISPID_SRSCurrentStreamNumber', 'SpeechLexiconType',
    'DISPID_SPPValue', 'eLEXTYPE_RESERVED6',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE19', 'SpeechRecognizerState', 'SVF_None',
    'SpeechRecoProfileProperties', 'SECFIgnoreKanaType',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_PRIVATE8',
    'SAFT16kHz16BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SDKSetStringValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechEngineProperties', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE14', 'ISpeechLexiconWord', 'SPSTREAMFORMATTYPE',
    'DISPID_SRCResume', 'SVPAlert', 'SLTUser', 'ISpeechPhraseInfo',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_20',
    'DISPID_SMSALineId', 'SPSHT_Unknown', 'SAFTGSM610_11kHzMono',
    'ISpeechRecoResult2', 'SAFT44kHz16BitMono', 'SRCS_Enabled',
    'SpeechVoicePriority', 'DISPID_SPEActualConfidence',
    'DISPID_SRCERequestUI', 'SGRSTTTextBuffer', 'SPWORD',
    'DISPID_SpeechPhraseRules', 'SpMMAudioOut', 'SpeechInterference',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_11', 'SRSEDone',
    'DISPID_SWFEChannels', 'eLEXTYPE_USER_SHORTCUT',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SBSWrite',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SASCurrentDevicePosition',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCEBookmark',
    'eLEXTYPE_PRIVATE5', 'DISPID_SLPSymbolic', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechLexiconPronunciation', 'SPSNoun',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPIEnginePrivateData',
    'SAFT8kHz8BitMono', 'SAFT48kHz16BitStereo',
    'ISpObjectTokenCategory', 'SDTReplacement',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE13',
    'SPDKL_LocalMachine', 'DISPID_SCSBaseStream', 'DISPID_SGRClear',
    'DISPID_SGRInitialState', 'SSFMCreateForWrite',
    'DISPID_SGRsCommit', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPPFirstElement', 'ISpPhoneticAlphabetSelection',
    'ISpeechLexicon', 'SAFT32kHz8BitStereo', 'SRESoundStart',
    'DISPID_SLPs_NewEnum', 'SpUnCompressedLexicon',
    'DISPID_SABufferInfo', 'DISPID_SPIReplacements',
    'DISPID_SRGetFormat', 'SGDisplay', 'STSF_CommonAppData',
    'SPINTERFERENCE', 'SECNormalConfidence', 'DISPID_SGRId',
    'SGRSTTEpsilon', 'ISpNotifySink', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRStatus', 'SPPS_RESERVED3', 'SP_VISEME_21',
    'ISpRecoCategory', 'DISPID_SVEStreamStart', 'SP_VISEME_1',
    'DISPID_SOTMatchesAttributes', 'SLTApp',
    'DISPID_SRGSetTextSelection', 'SVF_Emphasis',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVRate', 'STSF_AppData',
    'DISPID_SLPLangId', 'SLOStatic', 'DISPID_SRRSpeakAudio',
    'DISPID_SGRAttributes', 'SPEI_RESERVED1', 'ISpeechRecoContext',
    'SGPronounciation', 'DISPID_SPARecoResult', 'SREStateChange',
    'SPCT_COMMAND', 'STCLocalServer', 'DISPID_SVSLastBookmark',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRULESTATE',
    'Speech_Max_Pron_Length', 'SAFT16kHz8BitStereo', 'SVP_16',
    'DISPID_SpeechObjectToken', 'DISPID_SVWaitUntilDone',
    'SAFTCCITT_ALaw_8kHzMono', 'SASRun', 'DISPID_SGRSTPropertyValue',
    'DISPID_SpeechAudio', 'SpInProcRecoContext', 'STSF_FlagCreate',
    'SAFT44kHz8BitMono', 'UINT_PTR',
    'SpeechPropertyHighConfidenceThreshold', 'SVESentenceBoundary',
    'SPPS_Modifier', 'DISPID_SASFreeBufferSpace',
    'SAFTADPCM_11kHzMono', 'eWORDTYPE_DELETED', 'SpPhraseInfoBuilder',
    'SpeechRecoContextState', 'SREFalseRecognition',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechMemoryStream', 'DISPID_SRRecognizer',
    'SAFTExtendedAudioFormat', 'DISPID_SOTRemoveStorageFileName',
    'SPSInterjection', 'eLEXTYPE_PRIVATE7', 'SpeechAllElements',
    'SpeechWordType', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPEI_MIN_SR',
    'ISpObjectToken', 'SP_VISEME_12', 'SRAONone',
    'DISPID_SVAlertBoundary', 'SpTextSelectionInformation', 'SVP_10',
    'SRAInterpreter', 'DISPID_SWFEFormatTag', 'ISpObjectWithToken',
    'DISPID_SpeechRecoResult2', 'DISPID_SOTsCount',
    'SpeechLoadOption', 'ISpDataKey', 'DISPID_SRGetPropertyString',
    'SPEI_SOUND_START', 'DISPID_SOTs_NewEnum',
    'SpeechCategoryAudioIn', 'eLEXTYPE_PRIVATE4',
    'DISPID_SVEAudioLevel', 'DISPID_SPRuleChildren', 'SSTTWildcard',
    'ISpeechAudio', 'DISPID_SPPName',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpRecognizer3',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SBOPause', 'DISPID_SRCEAdaptation',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRRTimes',
    'SPINTERFERENCE_TOOLOUD', 'SPPS_LMA',
    'ISpPhoneticAlphabetConverter', 'eLEXTYPE_PRIVATE11',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRSRule', 'SVP_8',
    'SAFT11kHz16BitStereo', 'SPSModifier', 'DISPID_SRCState',
    'SPPS_NotOverriden', 'DISPID_SPRuleName',
    'DISPID_SPEAudioStreamOffset',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechGrammarRules',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGetRecognizers', 'ISpVoice',
    'DISPID_SLWType', 'SpCustomStream', 'SLODynamic',
    'SpeechEngineConfidence', 'SPEVENT', 'SpeechDisplayAttributes',
    'ISpPhoneConverter', 'DISPID_SRRAudioFormat',
    'SpeechTokenShellFolder', 'DISPID_SDKGetlongValue', 'SRAImport',
    'DISPID_SPPsCount', 'SpeechTokenKeyAttributes', 'SPCT_DICTATION',
    'SVP_0', 'SpeechAudioFormatGUIDWave', 'DISPID_SOTCId',
    'SAFT48kHz8BitMono', 'DISPID_SDKOpenKey',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechPhraseReplacement',
    'SPEI_TTS_AUDIO_LEVEL', 'SITooLoud', 'SP_VISEME_8',
    'DISPID_SPRuleNumberOfElements', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPRuleEngineConfidence', 'SPAS_PAUSE', 'ISpLexicon',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRDisplayUI',
    'DISPID_SVEStreamEnd', 'SITooSlow', 'DISPID_SPIElements',
    'DISPID_SRRAudio', 'SPFM_OPEN_READWRITE', 'ISpNotifyTranslator',
    'DISPID_SRRGetXMLErrorInfo', 'SGDSActiveWithAutoPause',
    'DISPID_SVEBookmark', 'DISPID_SPERequiredConfidence', 'SPRULE',
    'SAFT22kHz8BitMono', 'SpeechAddRemoveWord', 'SINoise',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SVEEnginePrivate',
    'SpeechRegistryUserRoot', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRSCurrentStreamPosition', 'SAFT12kHz8BitMono',
    'SP_VISEME_19', 'SINone', 'SPEI_START_SR_STREAM',
    'ISpeechMMSysAudio', 'SPBINARYGRAMMAR', 'STCInprocHandler',
    'SPBO_PAUSE', 'DISPID_SOTCGetDataKey', 'DISPID_SRIsShared',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_SOUND_END',
    'DISPID_SVSInputWordLength', 'DISPID_SPELexicalForm',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', '_ISpeechVoiceEvents',
    'ISpeechResourceLoader', 'DISPID_SLPType', 'DISPID_SVPriority',
    'SWTAdded', 'ISpeechAudioBufferInfo', 'ISequentialStream',
    'DISPID_SBSSeek', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechPhraseElements', 'SPSVerb',
    'DISPID_SRCCreateResultFromMemory', 'Speech_Max_Word_Length',
    'DISPID_SpeechRecoResultTimes', 'SVSFParseSsml', 'DISPID_SAFGuid',
    'SVP_15', 'SPPS_Verb', 'DISPID_SLPsCount',
    'DISPID_SpeechLexiconProns', 'SREPropertyNumChange',
    'ISpeechPhoneConverter', 'SVSFIsNotXML', 'SRTSMLTimeout',
    'DISPID_SPPNumberOfElements', 'SGRSTTDictation',
    'DISPID_SRGCmdLoadFromMemory',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechGrammarRule', 'SpeechTokenIdUserLexicon',
    'ISpXMLRecoResult', 'SPEI_END_INPUT_STREAM', 'DISPID_SAVolume',
    'SRERecoOtherContext', 'SpeechDiscardType', 'tagSTATSTG',
    'ISpeechPhraseRule', 'DISPID_SPEEngineConfidence',
    'SSFMOpenReadWrite', 'SVSFDefault', 'SDTAlternates',
    'SPGRAMMARWORDTYPE', 'SpeechEmulationCompareFlags',
    'DISPID_SRRTStreamTime', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIRetainedSizeBytes', 'SPWORDPRONUNCIATIONLIST',
    'SpeechCategoryPhoneConverters', 'SpSharedRecoContext',
    'SPAS_CLOSED', 'SpCompressedLexicon', 'DISPID_SLWsItem',
    'DISPID_SVPause', 'SREAudioLevel', 'ISpRecoResult',
    'SpWaveFormatEx', 'SAFT12kHz16BitMono', 'SPLEXICONTYPE',
    'SPRECOGNIZERSTATUS', 'DISPID_SRRSaveToMemory', 'SPRST_ACTIVE',
    'SpeechUserTraining', 'DISPID_SPACommit',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechLexiconWord',
    'SpeechAudioState', 'SAFT22kHz16BitStereo', 'DISPID_SVSkip',
    'IInternetSecurityManager', 'SPCS_DISABLED', 'SP_VISEME_10',
    'SPRECORESULTTIMES', 'SVP_7', 'DISPID_SRCEInterference',
    'DISPID_SBSRead', 'SpStreamFormatConverter',
    'DISPID_SMSAMMHandle', 'SDKLCurrentUser', 'DISPID_SGRSTNextState',
    'SPSEMANTICFORMAT', 'SpeechGrammarTagDictation', 'SP_VISEME_16',
    'SAFT16kHz8BitMono', 'ISpeechWaveFormatEx', 'SPEI_TTS_PRIVATE',
    'eWORDTYPE_ADDED', 'SPAO_NONE', 'SITooFast', 'SPWF_SRENGINE',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRSTRule', 'SVSFVoiceMask',
    'SPPS_RESERVED2', 'SpeechVoiceSpeakFlags',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPILanguageId',
    'SpeechPropertyResponseSpeed', 'SPSHORTCUTPAIRLIST',
    'SpObjectTokenCategory', 'SRADynamic',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SGRSAddSpecialTransition', 'SpeechRuleAttributes',
    'DISPID_SDKSetBinaryValue', 'ISpeechAudioStatus',
    'SAFT22kHz8BitStereo', 'SAFT12kHz16BitStereo', 'SPVISEMES',
    'DISPID_SVSLastResult', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPEsItem', 'SRAORetainAudio', 'ISpeechGrammarRuleState',
    'SAFTADPCM_8kHzStereo', 'SPDKL_CurrentUser', 'SDTLexicalForm',
    'SP_VISEME_2', 'ISpeechGrammarRule', 'SPAS_STOP', 'SDTAudio',
    'SVP_5', 'DISPID_SMSADeviceId', 'SGSEnabled',
    'DISPID_SRSetPropertyString', 'DISPID_SRSNumberOfActiveRules',
    'SpShortcut', 'DISPID_SpeechMMSysAudio', 'SPSHT_OTHER',
    'ISpGrammarBuilder', 'DISPID_SRGState', 'DISPID_SRGReset',
    'SPPS_RESERVED1', 'SpeechWordPronounceable',
    'DISPID_SRCRetainedAudio', 'SAFT24kHz16BitStereo',
    'eLEXTYPE_RESERVED8', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPSNotOverriden', 'DISPID_SpeechObjectTokenCategory',
    'SpeechRetainedAudioOptions',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPCIdToPhone',
    'DISPID_SRCEStartStream', 'DISPID_SVSInputSentenceLength',
    'DISPID_SOTIsUISupported', 'DISPID_SRCCreateGrammar',
    'DISPID_SRRSetTextFeedback', 'SVP_12', 'SECLowConfidence',
    'SP_VISEME_13', 'SSFMOpenForRead', 'DISPID_SRCreateRecoContext',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTsItem',
    'DISPID_SPRulesItem', 'SPEI_VISEME', 'SPSLMA',
    'ISpeechFileStream', 'SRADefaultToActive',
    'DISPID_SRGDictationSetState', 'DISPID_SRRAlternates',
    'DISPID_SVVoice', 'SPWAVEFORMATTYPE', 'SVSFUnusedFlags',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechPhraseElement',
    'SPLOADOPTIONS', 'DISPID_SVSInputWordPosition',
    'ISpeechGrammarRules', 'DISPID_SVGetProfiles', 'DISPID_SVEViseme',
    'SPSHORTCUTTYPE', 'SP_VISEME_18', 'DISPID_SpeechVoice',
    'SVF_Stressed', 'DISPID_SLWsCount', 'SREPrivate',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCEventInterests',
    'SRTStandard', 'DISPID_SpeechPhraseInfo', 'DISPID_SRRTTickCount',
    'SVSFIsXML', 'SAFT8kHz16BitMono', 'SSTTDictation', 'SVP_19',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVVolume', 'DISPID_SVSInputSentencePosition',
    'DISPID_SWFEBlockAlign', 'ISpeechLexiconPronunciation',
    'SpSharedRecognizer', 'SAFTADPCM_22kHzMono', 'SP_VISEME_15',
    'SVEBookmark', 'DISPID_SOTGetAttribute', 'SAFT12kHz8BitStereo',
    'SPDKL_DefaultLocation', 'SRTAutopause', 'SRSActiveAlways',
    'DISPID_SPAsCount', 'SAFT24kHz8BitStereo',
    'DISPID_SGRSTPropertyName', 'SRSInactive', 'SAFTADPCM_44kHzMono',
    'SAFT11kHz16BitMono', 'SPSEMANTICERRORINFO', 'ISpeechBaseStream',
    'SPFM_CREATE', 'DISPID_SPAPhraseInfo', 'SPWORDPRONUNCIATION',
    'SDKLDefaultLocation', 'SPPHRASEPROPERTY', 'SAFT24kHz16BitMono',
    'SPAR_Low', 'SpLexicon', 'SPCT_SLEEP', 'SpAudioFormat',
    'DISPID_SPRNumberOfElements', 'SPEI_RESERVED2', 'SFTInput',
    'SPPS_Function', 'SPEI_RESERVED3', 'ISpeechPhraseElements',
    'SPFM_CREATE_ALWAYS', 'SGLexicalNoSpecialChars',
    'DISPID_SWFEBitsPerSample', 'SDA_No_Trailing_Space',
    'DISPID_SAStatus', 'DISPID_SREmulateRecognition', 'SBONone',
    'DISPID_SPISaveToMemory', 'SAFT32kHz16BitMono',
    'DISPID_SVAudioOutputStream', 'SVPNormal', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_20', 'Speech_StreamPos_RealTime',
    'DISPID_SRCCmdMaxAlternates', 'SPVPRI_ALERT',
    'SSSPTRelativeToStart', 'SREBookmark',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRSTsCount',
    'DISPID_SVEPhoneme', 'SGSDisabled', 'SPEI_RESERVED6',
    'DISPID_SPIEngineId', 'SPEI_SR_RETAINEDAUDIO',
    'SPDATAKEYLOCATION', 'STSF_LocalAppData', 'SAFT32kHz8BitMono',
    'eLEXTYPE_RESERVED9', 'DISPID_SRGRules', 'SVEViseme',
    'eLEXTYPE_PRIVATE3', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPANumberOfElementsInResult', 'SRARoot',
    'SpeechPropertyResourceUsage', 'SP_VISEME_17', 'SP_VISEME_0',
    'DISPID_SVSCurrentStreamNumber', 'SECFIgnoreWidth',
    'SPEI_REQUEST_UI', 'DISPID_SPIAudioSizeBytes', 'IEnumString',
    'SAFT48kHz16BitMono', 'SpStream', 'SRCS_Disabled',
    'SPCONTEXTSTATE', 'SDA_One_Trailing_Space', 'ISpAudio',
    'eLEXTYPE_VENDORLEXICON', 'SpMMAudioEnum', 'SREInterference',
    'DISPID_SGRSTsItem', 'SAFTGSM610_44kHzMono',
    'DISPID_SLGenerationId', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_PRIVATE1', 'SPEI_PHONEME', 'ISpPhrase',
    'SpeechVoiceEvents', 'SPCT_SUB_DICTATION', 'SPGRAMMARSTATE',
    'DISPID_SRRTLength', 'DISPID_SPRuleId',
    'DISPID_SpeechRecognizerStatus', 'SPXRO_SML', 'SPAR_Medium',
    'DISPID_SPIGetDisplayAttributes', 'SRSEIsSpeaking',
    'DISPID_SRCVoicePurgeEvent', 'SREPhraseStart',
    'SVEEndInputStream', 'SVEVoiceChange', 'DISPID_SPRsItem',
    'ISpeechRecognizer', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechLexicon',
    'SPBO_TIME_UNITS', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SOTCreateInstance', 'SPRECOCONTEXTSTATUS',
    'eLEXTYPE_PRIVATE15', 'ISpeechObjectToken', 'SSTTTextBuffer',
    'DISPID_SRCBookmark', 'SAFTText', 'DISPID_SOTGetStorageFileName',
    'ISpeechPhraseRules', 'DISPID_SGRs_NewEnum', 'SVP_17',
    'SpeechPartOfSpeech', 'SAFTADPCM_11kHzStereo', 'DISPID_SASState',
    'SP_VISEME_7', 'SpeechAudioFormatGUIDText', 'SGRSTTWord',
    'DISPID_SDKEnumValues',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SGLexical',
    'SPLO_STATIC', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPIProperties', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRRTOffsetFromStart', 'SPCATEGORYTYPE', 'eLEXTYPE_USER',
    'SREAllEvents', 'SpeechTokenKeyUI', 'SPINTERFERENCE_TOOSLOW',
    'SpInprocRecognizer', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPPConfidence', 'DISPID_SPEPronunciation',
    'DISPID_SABIBufferSize', 'DISPID_SRCERecognitionForOtherContext',
    'SPTEXTSELECTIONINFO', 'SREStreamStart', 'SpeechGrammarWordType',
    'ISpeechRecognizerStatus', 'SVSFPersistXML', 'SpFileStream',
    'DISPID_SRCSetAdaptationData', 'SVSFNLPMask',
    'DISPID_SRRRecoContext', 'DISPID_SRRDiscardResultInfo',
    'SPAR_High', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechRuleState', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechLexiconWords', 'SVEStartInputStream',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SVIsUISupported', 'DISPID_SRCESoundStart',
    'DISPID_SRCEPropertyNumberChange', 'SGRSTTWildcard',
    'SPEI_PHRASE_START', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SP_VISEME_5', 'DISPID_SpeechRecoContext', 'SpNullPhoneConverter',
    'DISPID_SVSpeak', 'SAFT32kHz16BitStereo', 'DISPID_SPIRule',
    'DISPID_SRCESoundEnd', 'DISPID_SOTId', 'STCRemoteServer',
    'SREAdaptation', 'ISpRecoGrammar2', 'SpeechCategoryRecognizers',
    'DISPID_SPRs_NewEnum', 'SVP_3', 'SPAUDIOSTATE',
    'DISPID_SpeechVoiceStatus', 'SpObjectToken',
    'ISpeechXMLRecoResult', 'DISPID_SBSFormat', 'SpeechTokenContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPWT_DISPLAY',
    'DISPID_SRState', 'SPSFunction', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSTs_NewEnum', 'eLEXTYPE_PRIVATE12',
    'SAFT11kHz8BitStereo', 'SpeechTokenValueCLSID',
    'DISPID_SPEAudioSizeTime', 'SECHighConfidence',
    'DISPID_SPPChildren', 'SVP_1', 'SPEI_RESERVED5',
    'DISPID_SpeechAudioBufferInfo', 'SVEAllEvents',
    'ISpeechPhraseAlternate', 'DISPID_SOTGetDescription',
    'SVSFlagsAsync', 'ISpEventSink', 'DISPID_SGRSAddWordTransition',
    'SRTExtendableParse', 'SVSFParseSapi',
    'DISPID_SRCRequestedUIType', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPAStartElementInResult', 'ISpeechPhraseElement',
    'SASStop', 'DISPID_SLGetPronunciations', 'SAFT8kHz8BitStereo',
    'SAFT24kHz8BitMono', 'SpeechMicTraining', 'SPBO_NONE',
    'ISpMMSysAudio', 'SPEI_MAX_TTS', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SLGetWords', 'SPPHRASEELEMENT', 'SPDKL_CurrentConfig',
    'SpeechGrammarState', 'SPAS_RUN', 'DISPID_SPCLangId',
    'ISpeechPhraseAlternates', 'DISPID_SPCPhoneToId', 'SRAExport',
    'SAFT48kHz8BitStereo', 'SREStreamEnd', 'DISPID_SAEventHandle',
    'SpeechCategoryAudioOut', 'DISPID_SABufferNotifySize',
    'ISpeechAudioFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPFM_NUM_MODES', 'SRATopLevel', 'SVP_14',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLPsItem',
    'DISPID_SPRules_NewEnum', 'DISPID_SOTCategory',
    'SpeechPropertyAdaptationOn', 'DISPID_SVEWord', 'SPPS_RESERVED4',
    'SASClosed', 'SPFM_OPEN_READONLY', 'SPWORDLIST',
    'SpeechFormatType', 'ISpeechMemoryStream', 'SPEI_MIN_TTS',
    'DISPID_SRCEPhraseStart', 'WAVEFORMATEX', 'DISPID_SRCVoice',
    'SPEI_ADAPTATION', 'SP_VISEME_14', 'DISPID_SVGetVoices',
    'SpeechSpecialTransitionType', 'SVP_13',
    'DISPID_SVGetAudioInputs', 'STCAll', 'DISPID_SDKDeleteValue',
    'ISpEventSource', 'SGDSActiveUserDelimited', 'SpeechRecoEvents',
    'eLEXTYPE_RESERVED7', 'DISPID_SRGDictationUnload',
    'eLEXTYPE_PRIVATE9', 'SpPhoneticAlphabetConverter',
    'eLEXTYPE_RESERVED10', 'SSSPTRelativeToCurrentPosition',
    'SP_VISEME_6', 'SPFILEMODE', 'SAFT16kHz16BitStereo',
    'SPVPRI_NORMAL', 'SP_VISEME_4', 'SPEI_END_SR_STREAM',
    'SFTSREngine', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPVOICESTATUS',
    'SPPS_Unknown', 'DISPID_SVStatus', 'DISPID_SGRsFindRule',
    'DISPID_SpeechPhraseAlternate', 'SPINTERFERENCE_NOSIGNAL',
    'SRTReSent', 'DISPIDSPRG', 'DISPID_SRRGetXMLResult',
    'STCInprocServer', 'DISPID_SVDisplayUI',
    'DISPID_SPIAudioSizeTime', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPEsCount', 'SPPARTOFSPEECH', 'DISPID_SRCEEnginePrivate',
    'SASPause', 'DISPID_SGRAddResource', 'SpeechVisemeType',
    'SPWF_INPUT', 'DISPID_SPERetainedStreamOffset',
    'SpResourceManager', 'SRERecognition', 'DISPID_SVSRunningState',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRGSetWordSequenceData',
    'SpeechVoiceCategoryTTSRate', 'SRTEmulated', 'SPPS_Noncontent',
    'SpeechDictationTopicSpelling', 'ISpeechPhraseReplacement',
    'SDKLCurrentConfig', 'DISPID_SpeechPhraseReplacements',
    'SPPHRASEREPLACEMENT', 'eLEXTYPE_LETTERTOSOUND', 'SSFMCreate',
    'ISpProperties', 'SpNotifyTranslator', 'SVSFParseAutodetect',
    'SPINTERFERENCE_NOISE', 'ISpSerializeState',
    'DISPIDSPTSI_ActiveLength', 'SRSActive', 'SpeechDataKeyLocation',
    'SVP_21', 'DISPID_SDKCreateKey', 'DISPID_SPPsItem',
    'DISPID_SLWWord', 'SPXRO_Alternates_SML',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechAudioFormatType',
    'SVSFNLPSpeakPunc', 'DISPID_SRCEHypothesis', 'IStream',
    'SWPUnknownWordPronounceable', 'DISPID_SRSAudioStatus',
    'SWPKnownWordPronounceable', 'ISpeechRecoResultTimes',
    'DISPID_SLAddPronunciation', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPRDisplayAttributes', 'SPINTERFERENCE_NONE',
    'DISPID_SRGDictationLoad', 'SDKLLocalMachine', 'SpPhoneConverter',
    'SVEAudioLevel', 'SVP_18', 'DISPID_SLGetGenerationChange',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechBaseStream',
    'DISPID_SASCurrentSeekPosition', 'SAFTADPCM_8kHzMono',
    'ISpeechObjectTokenCategory', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechPhraseProperty', 'SPWORDPRONOUNCEABLE',
    'SAFTADPCM_44kHzStereo', 'SPEI_FALSE_RECOGNITION', 'SRESoundEnd',
    'ISpeechPhraseInfoBuilder', 'ISpeechTextSelectionInformation',
    'SVEPhoneme', 'SAFTNonStandardFormat', 'SAFT11kHz8BitMono',
    'SPWT_LEXICAL', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVAudioOutput', 'SPLO_DYNAMIC', 'SVSFIsFilename',
    'DISPID_SRAudioInputStream', 'ISpeechObjectTokens',
    'DISPID_SMSSetData', 'DISPID_SGRAddState', 'DISPID_SPRsCount',
    'ISpPhraseAlt', 'SDTProperty', 'SDTPronunciation',
    'DISPID_SRCEEndStream', 'SWTDeleted', 'SGRSTTRule',
    'SpeechCategoryAppLexicons', 'ISpRecoContext',
    'DISPID_SLRemovePronunciation', 'ISpNotifySource',
    'DISPID_SABIEventBias', 'SPEI_VOICE_CHANGE', 'ISpeechDataKey',
    'DISPID_SPPParent', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRulesCount', 'SPCS_ENABLED', 'ISpeechLexiconWords',
    'tagSPPROPERTYINFO', 'ISpeechRecoResultDispatch',
    'SPEI_RECOGNITION', 'IInternetSecurityMgrSite',
    'SPINTERFERENCE_TOOQUIET', 'SpeechTokenKeyFiles',
    'SDA_Consume_Leading_Spaces', 'DISPID_SOTDisplayUI',
    'DISPID_SVEVoiceChange', 'DISPID_SABIMinNotification',
    'SPXMLRESULTOPTIONS', 'SpeechVisemeFeature', 'SVP_2',
    'DISPID_SRGId', 'DISPID_SRCERecognition', 'SPEI_SR_PRIVATE',
    'DISPID_SVSpeakStream', 'DISPID_SLWPronunciations', 'SVP_9',
    'eLEXTYPE_PRIVATE10', 'DISPID_SAFGetWaveFormatEx',
    'SpeechStreamSeekPositionType', 'SPPS_Noun', 'SPSERIALIZEDPHRASE',
    'SPAUDIOSTATUS', 'DISPIDSPTSI', 'SVP_4', 'Speech_Default_Weight',
    'SPPHRASE', 'DISPID_SAFType', 'SVPOver', 'DISPID_SPPs_NewEnum',
    'SAFT8kHz16BitStereo', 'SPSHT_EMAIL', 'SREPropertyStringChange',
    'SITooQuiet', 'SPEI_INTERFERENCE', 'SPSSuppressWord',
    'SpeechStreamFileMode', 'DISPID_SGRsAdd', 'DISPID_SOTCSetId',
    'SPSHORTCUTPAIR', 'SPAUDIOOPTIONS', 'SpeechAudioVolume',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRsCount', 'ISpShortcut',
    'SpeechBookmarkOptions', 'SPRS_ACTIVE_USER_DELIMITED',
    'SGDSActive', 'DISPID_SpeechXMLRecoResult', 'DISPID_SDKEnumKeys',
    'DISPID_SRAudioInput', 'DISPID_SPRText', 'eLEXTYPE_PRIVATE20',
    'SSSPTRelativeToEnd', 'SPAR_Unknown', 'DISPID_SPRFirstElement',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpResourceManager',
    'DISPID_SpeechCustomStream', 'DISPID_SFSClose',
    'SRSInactiveWithPurge', 'SpeechRunState', 'SPPROPERTYINFO',
    'SPEI_SR_BOOKMARK', 'DISPID_SOTRemove', 'DISPID_SpeechPhraseRule',
    'ISpStreamFormat', 'LONG_PTR', 'SVEWordBoundary', 'SPSUnknown',
    'SAFT44kHz8BitStereo', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SOTCDefault',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPRECOSTATE', 'SDTDisplayText',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechAudioFormat',
    'SPWT_PRONUNCIATION', 'DISPID_SOTSetId', 'SPPS_SuppressWord',
    'DISPID_SpeechAudioStatus', 'DISPID_SPERetainedSizeBytes',
    'SpeechCategoryVoices', 'SGSExclusive', '_RemotableHandle',
    'ISpeechPhraseProperty', 'SpMMAudioIn', 'SPADAPTATIONRELEVANCE',
    'SPBO_AHEAD', 'ISpeechCustomStream', 'SAFTNoAssignedFormat',
    'SpeechAudioProperties', 'DISPID_SVResume', 'DISPID_SGRSTWeight',
    'eLEXTYPE_PRIVATE2', 'SAFT22kHz16BitMono',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPRuleParent',
    'DISPID_SVSPhonemeId', 'ISpeechLexiconPronunciations',
    'DISPID_SRSSupportedLanguages', 'DISPID_SOTCEnumerateTokens',
    'ISpeechRecoResult', 'DISPID_SVSpeakCompleteEvent', 'SECFDefault',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SpeechDataKey',
    'SAFTDefault', 'SDTAll', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRSClsidEngine', 'SPRST_INACTIVE', '_SPAUDIOSTATE',
    'SPRS_ACTIVE', 'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_APP',
    'eLEXTYPE_PRIVATE17', 'DISPID_SFSOpen', 'DISPID_SPAsItem',
    'ISpRecoGrammar', 'DISPID_SRIsUISupported',
    'DISPID_SPEDisplayText', 'ISpRecoContext2',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE6',
    'DISPID_SMSGetData', 'DISPID_SRCAudioInInterferenceStatus',
    'SPSERIALIZEDRESULT', 'DISPID_SRCRecognizer',
    'DISPID_SLPPhoneIds', 'SPPS_Interjection', 'ISpeechVoiceStatus',
    'DISPID_SGRsItem', 'DISPID_SVEventInterests', 'SPGS_ENABLED',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPEs_NewEnum',
    'SVP_11', 'ISpeechPhraseReplacements', 'SPWORDTYPE',
    'Speech_StreamPos_Asap', 'DISPID_SPIStartTime',
    'DISPID_SGRSTType', 'SGDSInactive', 'SVEPrivate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechRecoResult', 'SPEVENTSOURCEINFO',
    'DISPID_SRGCommit', 'SpeechCategoryRecoProfiles',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVESentenceBoundary',
    'SPGS_DISABLED', 'DISPID_SVSVisemeId',
    'DISPIDSPTSI_SelectionLength', 'SPRST_NUM_STATES',
    'DISPID_SpeechRecognizer', 'tagSPTEXTSELECTIONINFO',
    'SECFEmulateResult', 'DISPID_SGRSTransitions', 'SPGS_EXCLUSIVE',
    'DISPID_SRCEFalseRecognition', 'SPVPRIORITY',
    'IEnumSpObjectTokens', 'ISpStream', 'ISpRecognizer',
    'SpeechRegistryLocalMachineRoot', 'SpMemoryStream'
]

_check_version('1.2.0', 1700136693.641634)
